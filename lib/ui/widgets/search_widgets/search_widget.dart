...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  @override
  void initState() {
    searchProvider = Provider.of<SearchPokemonsController>(context, listen: false);
                      ...
                      style: TextStyle(
                          color: isDark
                              ...
                              : isNameFilterSelected
                                  ? Colors.white
                                  : Colors.black)),
                  selectedColor: isDark ? constants.selectedDarkThemeColor : constants.selectedLightThemeColor,
              ...
              children: [
                Container(
                    ...
                    decoration: BoxDecoration(
                        color: constants.searchContainerLightThemeColor, borderRadius: BorderRadius.circular(constants.containerCornerRadius)),
                    child: Center(
                      child: TextField(
