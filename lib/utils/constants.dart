...
const Color scaffoldLightThemeColor = Color(0xFFDC0A2D);
...
const String homeScreenSubtitle = "Search for Pokemon by name or tap on a Pokemon card to know more about it.";
...
const Color favoriteIconContainerDarkThemeColor = Colors.white;
...
const double homeScreenSliverAppBarHeight = 140.0;
