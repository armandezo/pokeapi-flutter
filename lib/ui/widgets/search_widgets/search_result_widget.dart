...
class SearchResultItemWidget extends StatefulWidget {
  ...
  const SearchResultItemWidget({Key? key, required this.resultText, required this.nameFilter}) : super(key: key);
...
class _SearchResultItemWidgetState extends State<SearchResultItemWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    void navigateToAbilitiesData() async {
      Navigator.of(context).push(MaterialPageRoute(builder: (_) => SearchedAbilityScreen(abilityName: widget.resultText)));
    }
