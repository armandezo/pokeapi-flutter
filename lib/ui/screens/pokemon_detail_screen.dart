...
class _PokemonDetailScreenState extends State<PokemonDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> checkFavorite(String name) async {
      isFavorite = await Provider.of<PokemonFavoritesController>(context).isPokemonFavorite(name);
    }
                  ...
                  children: [
                    IconButton(
                        ...
                        icon: Icon(Icons.arrow_back_ios_new_rounded,
                            color: isDark ? constants.backIconDarkThemeColor : constants.backIconLightThemeColor,
                            size: constants.detailScreenIconSize)),
                    Text(pokemon.name,
                        style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                            fontWeight: FontWeight.bold,
                            color: isDark ? constants.pokemonNameDarkThemeColor : constants.pokemonNameTitleLightThemeColor)),
                    FutureBuilder(
                        ...
                        builder: (context, dataSnapShot) {
                          return IconButton(
                              ...
                              onPressed: () async {
                                await Provider.of<PokemonFavoritesController>(context, listen: false).toggleFavoritePokemon(pokemon.name);
                              },
                              icon: Icon(
                                Icons.favorite,
