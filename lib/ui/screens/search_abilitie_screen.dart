  ...
  Widget build(BuildContext context) {
    ...
    void navigateToPokemonData(String name, bool isDarkTheme) async {
      final Map<String, dynamic> pokemonData =
          await Provider.of<SearchPokemonsController>(context, listen: false).getPokemonDataByName(name, isDarkTheme);
      if (mounted) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => SearchedPokemonTerminalWidget(
                isDark: isDark, pokemon: pokemonData['pokemon'], imageUrl: pokemonData['imageUrl'], id: pokemonData['id'])));
      }
    }
          ...
          if (dataSnapShot.connectionState == ConnectionState.waiting) {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('Ability Description:', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: Colors.grey)),
                  const SizedBox(height: constants.smallPadding),
                  Text(flavorText, style: Theme.of(context).textTheme.titleLarge),
                  const SizedBox(height: constants.largePadding),
                  Text('Pokemons who use this ability:', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: Colors.grey)),
                  Expanded(
