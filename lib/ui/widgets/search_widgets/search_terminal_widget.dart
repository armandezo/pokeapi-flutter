...
class SearchedPokemonTerminalWidget extends StatelessWidget {
  ...
  const SearchedPokemonTerminalWidget({Key? key, required this.isDark, required this.pokemon, required this.imageUrl, required this.id})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Text('Click on the Pokemon card for more details', style: Theme.of(context).textTheme.titleMedium),
