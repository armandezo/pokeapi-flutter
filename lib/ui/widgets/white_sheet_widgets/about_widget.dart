      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TitleAndSubtitleWidget(title: 'Growth Rate', subtitle: growthRate.toString()),
            TitleAndSubtitleWidget(title: 'Habitat', subtitle: habitat.toString()),
            TitleAndSubtitleWidget(title: 'Capture Rate', subtitle: '${captureRate.toString()} %'),
            TitleAndSubtitleWidget(title: 'Base Happiness', subtitle: '${baseHappiness.toString()} point'),
            // egg groups list
